...
function Header() {
    ...
    return (
        <div className="landing-header">
            <SvgIcon color="primary" component={LuxorIcon} viewBox="0 0 174 40" style={{ minWidth: 174, minHeight: 40 }} />
                        ...
                        {({ TransitionProps }) => (
                            <Fade {...TransitionProps} timeout={200}>
                                <div className="tooltip">
                                    <Link className="tooltip-item" href="https://github.com/SoulSwapFinance" target="_blank">
