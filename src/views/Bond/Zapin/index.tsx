...
import { ftm, dai } from "../../../helpers/tokens";
...
import { wftm, wftm7, wftm14, wftm28 } from "../../../helpers/bond";
...
function Zapin({ open, handleClose, bond }: IZapinProps) {
    ...
    const setMax = () => {
        ...
        let amount: any = Math.min(maxBondPriceToken, token.isFtm ? token.balance * 0.99 : token.balance);
                    ...
                    <div className="zapin-body">
                        ...
                        <div className="zapin-body-params">
                            ...
                            <div className="data-row">
                                ...
                                <p className="data-row-value">{isLoading ? <Skeleton width="100px" /> : `~ ${trim(bond.bondQuote, 4)} LUX`}</p>
                            </div>
                            <div className="data-row">
                                <p className="data-row-name">Max You Can Buy</p>
                                <p className="data-row-value">{isLoading ? <Skeleton width="100px" /> : `${trim(bond.maxBondPrice, 4)} LUX`}</p>
                            </div>
                            <div className="data-row">
                                <p className="data-row-name">Price Discount</p>
