export const messages = {
    please_connect: "Please connect your wallet to the Fantom Opera network to use Luxor.",
    please_connect_wallet: "Please connect your wallet.",
    try_mint_more: (value: string) => `You're trying to mint more than the maximum payout available! The maximum mint payout is ${value} LUX.`,
    ...
    switch_to_fantom: "Switch to the Fantom Opera network?",
